...
Config.Weapons = {
    ...
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_rounds"), hash = `AMMO_PISTOL` }
    },
    {
    ...
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_flaregun"), hash = `AMMO_FLAREGUN` }
    },
    {
    ...
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_shells"), hash = `AMMO_SHOTGUN` }
    },
    {
    ...
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_rounds"), hash = `AMMO_SHOTGUN` }
    },
    {
    ...
    -- Heavy / Launchers
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_grenadelauncher"), hash = `AMMO_GRENADELAUNCHER` }
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_firework"), hash = `AMMO_FIREWORK` }
    },
    {
    ...
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_rockets"), hash = `AMMO_HOMINGLAUNCHER` }
    },
    {
        name = "WEAPON_MINIGUN",
        ...
        components = {},
        ammo = {
            label = _U("ammo_rounds"), hash = `AMMO_MINIGUN` }
    },
    {
        name = "WEAPON_RAILGUN",
        ...
        components = {},
        ammo = {
            label = _U("ammo_rounds"), hash = `AMMO_RAILGUN` }
    },
    {
        name = "WEAPON_RPG",
        label = _U("weapon_rpg"),
        ...
        components = {},
        ammo = {
            label = _U("ammo_rockets"), hash = `AMMO_RPG` }
    },
    {
    ...
    -- Thrown
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_ball"), hash = `AMMO_BALL` }
    },
    {
        name = "WEAPON_BZGAS",
        ...
        components = {},
        ammo = {
            label = _U("ammo_bzgas"), hash = `AMMO_BZGAS` }
    },
    {
        name = "WEAPON_FLARE",
        ...
        components = {},
        ammo = {
            label = _U("ammo_flare"), hash = `AMMO_FLARE` }
    },
    {
        name = "WEAPON_GRENADE",
        ...
        components = {},
        ammo = {
            label = _U("ammo_grenade"), hash = `AMMO_GRENADE` }
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_petrol"), hash = `AMMO_PETROLCAN` }
    },
    {
    ...
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_molotov"), hash = `AMMO_MOLOTOV` }
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_proxmine"), hash = `AMMO_PROXMINE` }
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_pipebomb"), hash = `AMMO_PIPEBOMB` }
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_snowball"), hash = `AMMO_SNOWBALL` }
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_stickybomb"), hash = `AMMO_STICKYBOMB` }
    },
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_smokebomb"), hash = `AMMO_SMOKEGRENADE` }
    },
    -- Tools
    {
        ...
        components = {},
        ammo = {
            label = _U("ammo_charge"), hash = `AMMO_FIREEXTINGUISHER` }
    },
